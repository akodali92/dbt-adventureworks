...
final as (
	...
	select
		...
		{{ dbt_utils.star(from=ref('dwh_dim_employee'), relation_alias='e', except=["business_entity_id", "national_id_number", "org_node", "org_level", "vacation_hours", "sick_leave_hours"]) }},
